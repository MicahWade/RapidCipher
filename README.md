...
* **Flexible Database Support:** Connect to a local SQLite file (default) or a remote database. Support is included for **MySQL, PostgreSQL, Firebird, Cassandra, and CouchDB**. See [MYSQL\_SETUP.md](https://github.com/MicahWade/RapidCipher/blob/main/MYSQL_SETUP.md) for a guide on setting up MySQL.
...
* **Database Drivers:**
    ...
    * CouchDB (LightCouch)
    * Gson (for CouchDB JSON handling)
...
1.  **Clone the repository:**
    `git clone https://github.com/MicahWade/RapidCipher.git`
    `cd rapidcipher`
